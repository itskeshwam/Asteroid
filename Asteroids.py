...
snd_fire = pygame.mixer.Sound(file="Sound/fire.wav")
snd_bangL = pygame.mixer.Sound(file="Sound/bangLarge.wav")
snd_bangM = pygame.mixer.Sound(file="Sound/bangMedium.wav")
snd_bangS = pygame.mixer.Sound(file="Sound/bangSmall.wav")
snd_extra = pygame.mixer.Sound(file="Sound/extra.wav")
snd_saucerB = pygame.mixer.Sound(file="Sound/saucerBig.wav")
snd_saucerS = pygame.mixer.Sound(file="Sound/saucerSmall.wav")
